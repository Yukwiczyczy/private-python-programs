...
from Database import get_view_list, print_view_list, store_to_db
    ...
    while True:
        ...
        def db_save():
            ...
            def device_method(tuple_data: tuple):
                ...
                # for att in temp_attendance:
                #   for employee_id, timestamp_, department, log_type, on_break, shift_ in att:
                    
                #     print(employee_id, timestamp_, department, log_type, on_break, shift_)
                #     store_to_db((employee_id, timestamp_, department, log_type, on_break, shift_)) 
        ...
        def timeline_db_save(user_input):
            ...
            def device_method(tuple_data: tuple):
                ...
                database_data_insertion(temp_attendance, location )
